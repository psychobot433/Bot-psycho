...
module.exports.onChat = async ({ api, event }) => {
  try {
    ...
    if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("janu")) {
      ...
      if (!userMessage) {
        const randomReplies = [
          "কথা দাও, তুমি আমার বস সৌরভ কে পটিয়ে নিবা! 🥺 না হলে কিন্তু আমি অভিমান করে বসে থাকবো! 😤💔",
          "তুমি যদি আমার বস সৌরভ কে পটাতে না চাও, তাহলে আমি কিন্তু তোমাকে পটানোর মিশনে নামবো! 😏🔥",
          "আমার বস সৌরভ কে কি একটু ভালোবাসা দিবা? 😚 নাহলে কিন্তু আমি কান্না করবো! 😭",
